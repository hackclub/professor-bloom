...
exports.handleLemmeWelcomeThem = void 0;
const fs_1 = __importDefault(require("fs"));
const yaml_1 = __importDefault(require("yaml"));
const welcomersFile = fs_1.default.readFileSync("welcomers.yaml", "utf8");
let installUrl;
...
const handleLemmeWelcomeThem = async ({ ack, body, client, say }) => {
    await ack();
    ...
    const yml = yaml_1.default.parse(welcomersFile);
...
exports.handleLemmeWelcomeThem = handleLemmeWelcomeThem;
