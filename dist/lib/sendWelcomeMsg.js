...
const sendWelcomeMsg = async (client, data) => {
    const channel = await (0, getLogChannel_1.getLogChannel)();
    ...
    try {
        ...
        const botMessages = result.messages?.filter((message) => message.bot_id);
...
//# sourceMappingURL=sendWelcomeMsg.js.map